...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center pt-24 px-4 text-center">
      ...
      {/* Results Container */}
      {result && (
        <div className="w-full max-w-3xl bg-white p-8 rounded-3xl shadow-xl border border-gray-100 mb-24 text-left animate-in fade-in slide-in-from-bottom-4 duration-500 mx-auto">
          {/* Status Header */}
            ...
            <div>
              ...
              {result.timestamp && (
                <p className="text-sm text-gray-500 font-medium">
                  {result.cached ? 'Loaded from cache' : 'Scanned just now'} &middot; {new Date(result.timestamp).toLocaleString()}
                </p>
              )}
            </div>
